...
const navigation = [
  ...
  { name: "Pay Bill", href: "/portal/pay-bill", icon: CreditCard, highlight: true },
  { name: "Payment History", href: "/portal/payments", icon: History },
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    item.highlight && !isActive && "border border-pink-200 bg-pink-50/50 text-pink-700 hover:bg-pink-50"
                  )}
                >
                  ...
                  {item.highlight && (
                    <span className="rounded-full bg-[#e2136e] px-2 py-0.5 text-[10px] font-bold text-white tracking-wide">
                      bKash
                    </span>
                  )}
                </Link>
