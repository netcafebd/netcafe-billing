...
export function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-xl border border-slate-200 bg-white shadow-xs transition-shadow duration-200",
        className
      )}
      {...props}
    />
...
export function CardTitle({
  ...
  return (
    <h3
      className={cn(
        "text-base sm:text-lg font-semibold leading-none tracking-tight text-slate-900",
        className
      )}
      {...props}
    />
